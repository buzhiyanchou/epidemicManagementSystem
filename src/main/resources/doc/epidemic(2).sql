/*
 ...
 Source Server         : mysql8-206
 Source Server Type    : MySQL
 Source Server Version : 80027
 Source Host           : 192.168.206.99:3308
...
CREATE TABLE `area`  (
  ...
  `area_type` int(0) NULL DEFAULT 1 COMMENT '区域类型1：防控区；2封控区',
...
CREATE TABLE `churuxinxi`  (
  ...
  `churucishu` int(0) NULL DEFAULT NULL COMMENT '出入次数',
...
CREATE TABLE `epidemiclog`  (
  ...
  `qz_time` datetime(0) NULL DEFAULT NULL COMMENT '确诊时间',
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `wzz_time` datetime(0) NULL DEFAULT NULL COMMENT '无症状确认时间',
  `gl_time` datetime(0) NULL DEFAULT NULL COMMENT ' 隔离时间',
  `zy_time` datetime(0) NULL DEFAULT NULL COMMENT ' 治愈时间',
...
-- ----------------------------
INSERT INTO `epidemiclog` VALUES ('1529976403372621826', '2022-05-27 08:02:54', 1653608046842, NULL, NULL, '2022-05-27 08:27:53', '2022-05-27 08:28:58', NULL);
INSERT INTO `epidemiclog` VALUES ('1529991354715828226', NULL, 1529990492115267586, NULL, '2022-05-27 09:02:12', '2022-05-27 09:02:46', NULL, NULL);
INSERT INTO `epidemiclog` VALUES ('1530024468452323329', '2022-05-27 11:13:54', 1530024192014135297, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `epidemiclog` VALUES ('1530024546046947329', '2022-05-27 11:14:13', 1530024239539793922, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `epidemiclog` VALUES ('1530024618889424897', '2022-05-27 11:14:30', 1530024239539793922, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `epidemiclog` VALUES ('1530024687885725697', '2022-05-27 11:14:47', 1530024266500780033, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `floor`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `area_id` bigint(0) NULL DEFAULT NULL COMMENT '区域号',
...
CREATE TABLE `foreign_personnel`  (
  ...
  `update_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '外来人员报备' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `goods_appointment`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `yonghu_id` bigint(0) NULL DEFAULT NULL,
  `goods_id` bigint(0) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '商品预约表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `goods_order`  (
  ...
  `yonghu_id` bigint(0) NULL DEFAULT NULL,
  `goods_id` bigint(0) NULL DEFAULT NULL,
  `goods_num` int(0) NULL DEFAULT NULL COMMENT '商品数',
  `total_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '商品总价',
  `goods_status` int(0) NULL DEFAULT 0 COMMENT '订单状态 0发货中，1已收货 2退货中 3已退货',
...
CREATE TABLE `location_info`  (
  ...
  `symptom` int(0) NULL DEFAULT NULL COMMENT '症状：0：无异常，1发烧， 2咳嗽， 3乏力， 呼吸困难',
  `is_hospitalize` int(0) NULL DEFAULT NULL COMMENT '是否就医:0 未就医， 1已就医',
  `insulate_status` int(0) NULL DEFAULT NULL COMMENT '隔离情况 0未隔离：1已被隔离',
...
CREATE TABLE `room`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `floor_id` bigint(0) NULL DEFAULT NULL,
...
CREATE TABLE `supplies_yonghu`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `supplies_id` bigint(0) NULL DEFAULT NULL,
  `yonghu_id` bigint(0) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `subscribe_count` int(0) NULL DEFAULT 1 COMMENT '预约次数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '社区物资和用户关联中间表' ROW_FORMAT = DYNAMIC;
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (1, 1, 'abo', 'users', '管理员', 'rqwiiwbcmct8k1inuaynatp9t9620zrl', '2022-03-10 14:29:00', '2022-05-24 05:40:56');
...
INSERT INTO `token` VALUES (4, 3, 'dio', 'users', '总管理员', 'ev38kn0xkwar38mq3uerhm3e94lhtkr0', '2022-04-24 20:19:19', '2022-05-24 10:52:47');
INSERT INTO `token` VALUES (5, 6, 'jojo', 'users', '管理员', 'w54jadvm42pfcmx9q0zcoalh692rk0ro', '2022-05-26 23:06:32', '2022-05-27 11:33:49');
...
CREATE TABLE `yonghu`  (
  ...
  `shouji` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机',
  `zhuzhi` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '住址',
  `status` tinyint(0) NOT NULL COMMENT '1正常 2确诊 3无症状感染者 ',
  `back_status` tinyint(0) NOT NULL COMMENT '1未隔离 2隔离 3已治愈',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of yonghu
-- ----------------------------
INSERT INTO `yonghu` VALUES (1529980645701324801, '2022-05-27 00:19:46', 'lisi', '123456', 'xiaosan', '男', NULL, '15112345678', 'shanghai', 0, 0);
INSERT INTO `yonghu` VALUES (1530024192014135297, '2022-05-27 11:13:54', 'zhagnsan', '123456', 'xiaosan', '男', NULL, '15112345678', 'shanghai', 1, 0);
INSERT INTO `yonghu` VALUES (1530024239539793922, '2022-05-27 11:14:30', 'zhaoliu', '123456', 'xiaosan', '男', NULL, '15112345678', 'shanghai', 1, 0);
INSERT INTO `yonghu` VALUES (1530024266500780033, '2022-05-27 11:14:47', '田七', '123456', 'xiaosan', '男', NULL, '15112345678', 'shanghai', 1, 0);
