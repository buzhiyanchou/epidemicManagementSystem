<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shangbaotupian" label="上报图片" prop="shangbaotupian">
          <file-upload
          tip="点击上传上报图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.shangbaotupian?ruleForm.shangbaotupian:''"
          @change="shangbaotupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shangbaotupian" label="上报图片" prop="shangbaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangbaotupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="个人体温" prop="gerentiwen">
          <el-input v-model="ruleForm.gerentiwen" 
              placeholder="个人体温" clearable  :readonly="ro.gerentiwen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="个人体温" prop="gerentiwen">
              <el-input v-model="ruleForm.gerentiwen" 
                placeholder="个人体温" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="风险地区" prop="fengxiandiqu">
          <el-select :disabled="ro.fengxiandiqu" v-model="ruleForm.fengxiandiqu" placeholder="请选择风险地区">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="风险地区" prop="fengxiandiqu">
	      <el-input v-model="ruleForm.fengxiandiqu"
                placeholder="风险地区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	userid : false,
      ...
      rules: {
          ...
          gerentiwen: [
                { required: true, message: '个人体温不能为空', trigger: 'blur' },
          ],
          shentizhuangkuang: [
          ],
          fengxiandiqu: [
                { required: true, message: '风险地区不能为空', trigger: 'blur' },
          ],
          shangbaoneirong: [
          ],
          shangbaoriqi: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangbaobiaoti = true;
          ...
          if(o=='shangbaotupian'){
            this.ruleForm.shangbaotupian = obj[o];
	    this.ro.shangbaotupian = true;
            continue;
          }
          if(o=='gerentiwen'){
            this.ruleForm.gerentiwen = obj[o];
	    this.ro.gerentiwen = true;
            continue;
          }
	    ...
	    this.ro.shentizhuangkuang = true;
          ...
          if(o=='fengxiandiqu'){
            this.ruleForm.fengxiandiqu = obj[o];
	    this.ro.fengxiandiqu = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.zhuzhi!=''&&json.zhuzhi){
          ...
          this.$message.error(data.msg);
            ...
            this.shentizhuangkuangOptions = "正常,不适".split(',')
	...
	if(this.ruleForm.shangbaotupian!=null) {
		this.ruleForm.shangbaotupian = this.ruleForm.shangbaotupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    shangbaotupianUploadChange(fileUrls) {
	this.ruleForm.shangbaotupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
