  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      ...
      >
        ...
        <el-form-item>
          <el-select v-model="searchForm.goodsTypeId" placeholder="请选择">
            <el-option
        ...
        >
          ...
          >
            <template slot-scope="{ row }">
              <el-image v-if="row.img" :src="$base.url + row.img"></el-image>
    ...
    >
      ...
      >
        ...
        <el-form-item label="商品分类" prop="goodsTypeId">
          <el-select v-model="dialogForm.goodsTypeId" placeholder="请选择">
            <el-option
              v-for="item in goodsType"
              :key="item.id+''"
              :label="item.typeName"
        ...
        <el-form-item label="物资图片">
          <file-upload
            ...
            :limit="1"
            :multiple="false"
            :fileUrls="dialogForm.img ? dialogForm.img : ''"
            @change="imgUploadChange"
          ></file-upload>
        </el-form-item>

        <el-form-item label="物资描述" prop="">
          <el-input
            type="textarea"
            :rows="2"
    ...
    confirmAreaFormHandle() {
      ...
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          that
            .$http({
              url: that.dialogitle == "添加" ? "/goods/save" : "/goods/update",
              method: "post",
              data,
            })
            .then(({ data: res }) => {
