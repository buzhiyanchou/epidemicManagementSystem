    ...
    >
      <block v-for="item in menuList" v-bind:key="item.roleName">
        <block
          ...
          v-bind:key="index"
          v-for="(menu, index) in item.frontMenu"
        >
            ...
            <block v-bind:key="sort2" v-for="(button, sort2) in child.buttons">
              <view
                :style="{
                  ...
                  margin: '0 2% 20rpx 2%',
                  borderColor: 'rgba(0,0,0,0)',
                  backgroundColor: 'rgba(0, 186, 189, 0)',
                  borderRadius: '12rpx',
                  borderWidth: '0',
                  width: '21%',
                  borderStyle: 'solid',
      ...
      >
        <view
          :style="{
            ...
            boxShadow: '0 2rpx 12rpx rgba(0,0,0,0)',
            margin: '0',
            borderColor: 'rgba(130, 163, 157, 1)',
            backgroundColor: 'rgba(203, 214, 211, 1)',
        ...
        <text
          ...
          @tap="goto('/pages/epidemic-map/epidemic-map')"
          >疫情地图</text>
      </view>
      <view
        v-if="false && 1 == 2"
        ...
        >
          <view class="list-item-body" style="flex: 1">
            <view
              :style="{
                padding: '0 20rpx',
                boxShadow: '0 0 12rpx rgba(255,0,0,0)',
                margin: '0',
                borderColor: 'red',
          ...
          <image
            :style="{
              ...
              boxShadow: '0 0 12rpx rgba(255,0,0,0)',
              margin: '0',
              borderColor: 'rgba(161, 185, 181, 1)',
              backgroundColor: 'rgba(255,0,0,0)',
              borderRadius: '50%',
              borderWidth: '8rpx',
              width: '200rpx',
...
export default {
  ...
  data() {
    return {
      ...
      autoplaySwiper: { delay: 5000, disableOnInteraction: false }
        ? true
        : false,
      intervalSwiper: { delay: 5000, disableOnInteraction: false }
        ? 5000
        : 5000,
      //轮播
      swiperList: [],
