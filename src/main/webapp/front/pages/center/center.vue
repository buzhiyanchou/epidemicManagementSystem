<template>
  <view class="content">
    <view
      @tap="onPageTap('../user-info/user-info')"
      class="header"
      ...
      :style="{
        ...
        backgroundColor: 'rgba(80, 96, 93, 1)',
        borderRadius: '0',
        borderWidth: '0',
        width: '100%',
        borderStyle: 'solid',
      ...
      >
        ...
        <view class="info">
          <view
            ...
            >{{ user.yonghuming
            }}<text v-if="user.vip && user.vip == '是'">(VIP)</text></view
          >
        </view>
      </view>
      <view class="setting">
    ...
    >
        ...
        >
          <block v-bind:key="sort" v-for="(child, sort) in menu.child">
            <view
              :style="{
                padding: '0',
                boxShadow: '0px 6rpx 12rpx rgba(0, 0, 0, 0.16)',
                margin: '20rpx 10rpx',
                backgroundColor: '#fff',
                borderColor: '#ccc',
                borderRadius: '0',
      ...
      <view
        @tap="onPageTap('../forum-add-or-update/forum-add-or-update')"
        :style="{
          padding: '0',
          boxShadow: '0px 6rpx 12rpx rgba(0, 0, 0, 0.16)',
          margin: '20rpx 10rpx',
      ...
      <view
        @tap="onPageTap('../forum-my/forum-my')"
        :style="{
          padding: '0',
          boxShadow: '0px 6rpx 12rpx rgba(0, 0, 0, 0.16)',
          margin: '20rpx 10rpx',
      ...
      >
		...
		<!-- <view class="location-fillout center-item">
			<text class="iconfont icon-position"></text>
			<text class="center-item-name">每日定位填报</text>
		</view> -->
      </view>

	  <!-- 定位填报 -->
		<view
        @tap="onPageTap('/pages/location/location')"
        :style="{
          padding: '0',
          boxShadow: '0px 6rpx 12rpx rgba(0, 0, 0, 0.16)',
          margin: '20rpx 10rpx',
    ...
    <!-- 社区防疫物资 -->
    <view
        @tap="onPageTap('/pages/community-supplies/community-supplies')"
        :style="{
          padding: '0',
          boxShadow: '0px 6rpx 12rpx rgba(0, 0, 0, 0.16)',
          margin: '20rpx 10rpx',
    ...
    <!-- 物资代购 -->
    <view
        @tap="onPageTap('/pages/supplies-bought/supplies-bought')"
        :style="{
          padding: '0',
          boxShadow: '0px 6rpx 12rpx rgba(0, 0, 0, 0.16)',
          margin: '20rpx 10rpx',
    ...
    <!-- 购物车 -->
    <view
        @tap="onPageTap('/pages/cart-list/cart-list')"
        :style="{
          padding: '0',
          boxShadow: '0px 6rpx 12rpx rgba(0, 0, 0, 0.16)',
          margin: '20rpx 10rpx',
    ...
    <!-- 我的订单 -->
    <view
        @tap="onPageTap('/pages/order-list/order-list')"
        :style="{
          padding: '0',
          boxShadow: '0px 6rpx 12rpx rgba(0, 0, 0, 0.16)',
          margin: '20rpx 10rpx',
