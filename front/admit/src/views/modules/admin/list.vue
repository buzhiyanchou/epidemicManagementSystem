      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        >
          ...
          <el-form-item label="角色">
            <el-select clearable v-model="searchForm.role" placeholder="请选择">
              <el-option
                label="管理员"
                value="管理员"
              ></el-option>
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              /></el-button>
              <el-button
                v-if="isAuth('admin', '查看') && contents.tableBtnIcon == 0"
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
                >{{ contents.tableBtnFont == 1 ? "详情" : "" }}</el-button
              ...
              /></el-button>
              <el-button
                v-if="isAuth('admin', '修改') && contents.tableBtnIcon == 0"
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
                >{{ contents.tableBtnFont == 1 ? "修改" : "" }}</el-button
              ...
              /></el-button>
              <el-button
                v-if="isAuth('admin', '删除') && contents.tableBtnIcon == 0"
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
                >{{ contents.tableBtnFont == 1 ? "删除" : "" }}</el-button
...
export default {
  data() {
    return {
      ...
      contents: {
        ...
        searchBtnBgColor: "rgba(12, 107, 92, 1)",
        inputTitleSize: "14px",
        btnAdAllBorderColor: "rgba(255, 255, 255, 1)",
        pageJumper: true,
        btnAdAllIconPosition: "1",
        searchBoxPosition: "2",
        tableBtnDetailFontColor: "rgba(12, 107, 92, 1)",
        tableBtnHeight: "40px",
        pagePager: true,
        ...
        tableBtnIcon: "1",
        btnAdAllHeight: "40px",
        btnAdAllWarnBgColor: "rgba(12, 107, 92, 1)",
        btnAdAllBorderWidth: "3px",
        tableStripeFontColor: "#606266",
        tableBtnBorderStyle: "dashed ",
        inputHeight: "38px",
        btnAdAllBorderRadius: "0px",
        btnAdAllDelBgColor: "rgba(12, 107, 92, 1)",
        pagePrevNext: true,
        btnAdAllAddBgColor: "rgba(12, 107, 92, 1)",
        searchBtnFont: "1",
        tableIndex: true,
        btnAdAllIcon: "1",
        tableSortable: false,
        ...
        box: {
          ...
          flag: "1",
          backgroundImage:
            "http://codegen.caihongy.cn/20211124/6df9f5a0a7664aa9b5f63de039ed2094.png",
          background: "#fff",
        },
        inputBorderWidth: "3px",
        inputFontPosition: "1",
        inputFontColor: "rgba(12, 107, 92, 1)",
        pageEachNum: 10,
        tableHeaderBgColor: "rgba(12, 107, 92, 1)",
        inputTitleColor: "rgba(12, 107, 92, 1)",
        ...
        inputBorderColor: "rgba(12, 107, 92, 1)",
        tableShowHeader: true,
        tableHoverBgColor: "#f5f5f5",
        tableBtnFontSize: "14px",
        tableBtnBorderColor: "rgba(12, 107, 92, 1)",
        inputIconPosition: "2",
        tableBorder: true,
        btnAdAllBorderStyle: "dashed ",
        tableBtnBorderWidth: "3px",
        tableStripeBgColor: "#F5F7FA",
        tableBtnEditFontColor: "rgba(12, 107, 92, 1)",
        tableAlign: "center",
      },
      layouts: "",
    };
  ...
  methods: {
    ...
    getDataList() {
      ...
      if(this.searchForm.role != "" && this.searchForm.role != undefined)params["role"] = this.searchForm.role
      this.$http({
        url: "users/page",
        method: "get",
        params: params,
